...
class MainWindow(QMainWindow):
    ...
    def get_max_priority(self):
        try:
            return self._task_service.get_max_priority()
    ...
    def load_tasks(self):
        try:
            df = self._task_service.get_all_tasks()
    ...
    def add_task(self):
        try:
            ...
            self._task_service.add_task(title, description, status, priority)
    ...
    def update_task_status(self):
        try:
            ...
            self._task_service.update_task_status(int(task_id), new_status)
